...
const Cartpage = () => {
    ...
    const makePayment = async () => {
        ...
        ("pk_test_51PFqUTSBFwDYp6Iq9IGFqXbqliYSwrBXMhS6AYnrjUvmu3i2abWreIEIjYg7bYHGyhxdK2wkUESvzFv9uvVRTZtm00dUdSBUFD")
    ...
    //setProducts is a function used to update the list of products displayed on the
page
